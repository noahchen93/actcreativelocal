...
13. SEO quick-fix batch on 2026-06-28 (by Claude, on Codex's behalf; branch `codex/Christmas-NewYear-CNY`). Not yet deployed at commit time — pending user decision on preview vs production.
