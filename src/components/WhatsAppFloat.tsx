...
export function WhatsAppFloat() {
  return (
    <a
      ...
      aria-label="Chat with ACT Creative on WhatsApp"
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe57] text-white rounded-full shadow-2xl shadow-black/40 px-5 py-3 transition-all hover:scale-105"
    >
